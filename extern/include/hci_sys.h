...
#define SYS_MODULE    "HCI_SYS"
    ...
    typedef enum {
        ...
        HCI_ERR_COMPRESS_DATA_FAILED,			///< 25: 压缩数据失败
        HCI_ERR_ROCKEY_INVALID,                 ///< 26: 加密锁授权失败
        ...
        HCI_ERR_ASR_SAVE_GRAMMAR_FAILED,		///< 218: 保存语法文件（wfst）失败
		HCI_ERR_ASR_GRAMMAR_ID_EMPTY,           ///< 219: 语法文件列表为空
        ...
        HCI_ERR_OCR_NOT_BIZCARD,                ///< 421: OCR识别图片中不包含名片信息
        HCI_ERR_OCR_NO_TEXT,                    ///< 422: OCR识别图片中不包含文本信息
        HCI_ERR_OCR_INVALID_SIZE_IMAGE,         ///< 423: OCR识别图片尺寸不合法（太大或太小）
        HCI_ERR_OCR_IMAGE_DARK,                 ///< 424: OCR识别图片光线太暗
